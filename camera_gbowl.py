...
if __name__ == "__main__":
	...
	ax3.hlines(y=-0.2, xmin=xmin, xmax=0, linewidth=2, color='#89F336')
	ax3.hlines(y=0.4, xmin=xmin, xmax=0, linewidth=2, color='#0000FF')
	ax3.hlines(y=-0.4, xmin=xmin, xmax=0, linewidth=2, color='#0000FF')
	ax3.hlines(y=0.6, xmin=xmin, xmax=0, linewidth=2, color='#FF69B4')
	ax3.hlines(y=-0.6, xmin=xmin, xmax=0, linewidth=2, color='#FF69B4')
	ax3.hlines(y=0.8, xmin=xmin, xmax=0, linewidth=2, color='#FF0000')
	ax3.hlines(y=-0.8, xmin=xmin, xmax=0, linewidth=2, color='#FF0000')
	ax3.hlines(y=1.0, xmin=xmin, xmax=0, linewidth=2, color='#FFFFFF')
	ax3.hlines(y=-1.0, xmin=xmin, xmax=0, linewidth=2, color='#FFFFFF')
	...
	lines_y, = ax3.plot(x_t, y_y, '#ff4500', linewidth=5.0)
	x_txt = xmin; s_txt = 15
	ax3.text(x_txt, 0.21, '0.05G', color='#89F336', size=s_txt)
	ax3.text(x_txt, 0.41, '0.1G', color='#0000FF', size=s_txt)
	ax3.text(x_txt, 0.61, '0.2G', color='#FF69B4', size=s_txt)
	ax3.text(x_txt, 0.81, '0.3G', color='#FF0000', size=s_txt)
	ax3.text(x_txt, -0.19, '-0.05G', color='#89F336', size=s_txt)
	ax3.text(x_txt, -0.39, '-0.1G', color='#0000FF', size=s_txt)
